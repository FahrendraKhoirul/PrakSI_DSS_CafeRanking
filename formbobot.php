    ...
    <div class="container card shadow p-5 mt-5">
      <form action="insertbobot.php" method="POST">
        <div class="form-group">
          ...
          <input type="text" name="idbobot" class="form-control" required="" placeholder="Insert ID Bobot" id="idbobot">
        </div>
        <div class="form-group">
          <label for="idkrit">ID Kriteria</label>
          <select class="form-control" name="idkrit">
            <?php
            include "config.php";
        ...
        <div class="form-group">
          ...
          <input type="text" name="value" class="form-control" required="" placeholder="Insert Value" id="value">
        </div>
