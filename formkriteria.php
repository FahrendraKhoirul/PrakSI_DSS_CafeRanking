    ...
    <section id="hero" class="d-flex align-items-center justify-content-center">
      <div class="container card shadow p-5 mt-5">
        <form action="insertkriteria.php" method="POST">
          <div class="mb-3">
            <label for="idkrit" class="form-label">ID Kriteria</label>
            <input type="text" class="form-control" id="idkrit" name="idkrit">
          </div>
          <div class="mb-3">
            <label for="nmkrit" class="form-label">Nama Kriteria</label>
            <input type="text" class="form-control" id="nmkrit" name="nmkrit">
          </div>
