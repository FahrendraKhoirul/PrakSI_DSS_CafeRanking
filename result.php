    ...
    <section>
      <div class="container card shadow p-5 mt-5">
        ...
        <table class="table table-hover">
          ...
          include "config.php";
          $no = 1;
          $kat = mysqli_query($conn, "SELECT nilai.id_nilai, alternatif.*, kriteria.*, bobot.id_bobot, 
          bobot.value, skala.value AS nilai, skala.nama_skala FROM nilai, skala, 
          bobot, kriteria, alternatif WHERE nilai.id_alternatif = alternatif.id_alternatif
          AND nilai.id_bobot = bobot.id_bobot AND nilai.id_skala = skala.id_skala
        ...
        <table class="table table-hover">
          ...
          include "config.php";
          $no = 1;
          $kat = mysqli_query($conn, "SELECT vnilai.*, (vnilai.nilai / nilaimax.maksimum) AS
          normalisasi FROM vnilai, nilaimax WHERE 
          nilaimax.id_kriteria = vnilai.id_kriteria GROUP BY
          vnilai.id_nilai");
          while ($p = mysqli_fetch_array($kat)) {
