  ...
  <section id="hero" class="d-flex align-items-center justify-content-center">
    <div class="container card shadow p-5 mt-5">
      <form action="insertalternatif.php" method="POST">
        <div class="mb-3">
          <label for="idalt" class="form-label">ID Alternatif</label>
          <input type="text" class="form-control" id="idalt" name="idalt">
        </div>
        <div class="mb-3">
          <label for="nmalt" class="form-label">Nama Alternatif</label>
          <input type="text" class="form-control" id="nmalt" name="nmalt">
        </div>
