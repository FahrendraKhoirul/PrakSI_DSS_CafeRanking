    ...
    <section id="hero" class="d-flex align-items-center justify-content-center">
      <div class="container card shadow p-5 mt-5">
        <form action="insertskala.php" method="POST">
          <div class="mb-3">
            <label for="idskala" class="form-label">ID Skala</label>
            <input type="text" class="form-control" id="idskala" name="idskala" aria-describedby="emailHelp">
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="keterangan" class="form-label">Nama Skala</label>
